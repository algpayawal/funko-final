 ...
 const Navigation = () => {
     ...
     return ( <
         ...
         input type = "text"
         placeholder = 'Search'
         className = 'border-none outline-none w-[10rem]' / >
         <
         /div> <
         ...
         li className = 'menu'
         onClick = {
             () => setShow(true) } > < i class = "fa-sharp fa-solid fa-bars" > < /i></li >
         <
         /ul> {
             show ? < SideNavigation closeNav = { setShow }
             />:null
         } <
         /nav>
     )
 ...
 const SideNavigation = ({ closeNav }) => {
     return ( <
         ...
         <
         li onClick = {
             () => closeNav(false) } > < i class = "fa-regular fa-xmark x " > < /i></li >
         <
         /ul> <
         ul className = 'ul2' >
         <
         ...
         ul className = 'ul3' >
         <
         SideNavItem img = { hero }
         label = { "HEROES" }
         sublabel = { "&Villains" }
         /> <
         SideNavItem img = { orange }
         label = { "ANIMATION" }
         sublabel = { "&Cartoons" }
         /> <
         SideNavItem img = { supman }
         label = { "MOVIES" }
         sublabel = { "&TV" }
         /> <
         SideNavItem img = { colonel }
         label = { "ICONS" }
         sublabel = { "&Sports " }
         /> <
         SideNavItem img = { maskot }
         label = { "SHOP" }
         sublabel = { "&By Type" }
         /> <
         SideNavItem img = { sawyer }
         label = { "SHOP ALL" }
         sublabel = { "" }
         />
